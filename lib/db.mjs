...
export const taxRateFor = (contactId, override) => {
  ...
  return buyer?.tax_exempt ? 0 : clampRate(getSettings().tax_rate)
}
...
export { computeTotals, lineAmount, lineQty, lineUpcharge, sizeTotal, sizeSummary, rollupSizes, garmentLines, SIZES } from '../public/js/shared/pricing.js'
