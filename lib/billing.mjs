...
export const PLANS = {
  everything: {
    ...
    features: [
      ...
      'AI receptionist, automations, gang sheets, separations',
  ...
  growth: {
    ...
    features: ['Everything in Starter', 'Profit on every job (live margin)', 'Separation Studio', 'Embeddable gang-sheet builder (your Stripe)', 'QuickBooks export', 'AI receptionist', 'Unlimited seats'],
    seats: Infinity,
  },
  pro: {
