...
async function doQuote(msg) {
  ...
  // "…for Northgate" resolves a real customer, who may well be a resale account. Derive the
  // rate here, above the no-customer branch, so the preview number and the saved estimate agree.
